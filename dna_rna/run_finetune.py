...
# sys.path.append("/media/dasdata3/fuying/BERT/DNABERT/src")
# from transformers.tokenization_bert import DNATokenizer
    ...
    for pred_task, pred_output_dir in zip(pred_task_names, pred_outputs_dirs):
        ...
        for batch in tqdm(pred_dataloader, desc="Predicting"):
            ...
            with torch.no_grad():
                ...
                # atten_scores= np.mean(attention, axis=1)
                np.save("atten_test.npy", attention)
                _, logits = outputs[:2]
